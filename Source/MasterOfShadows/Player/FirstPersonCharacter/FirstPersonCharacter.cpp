...
AFirstPersonCharacter::AFirstPersonCharacter()
{
	...
	// Note: The ProjectileClass and the skeletal mesh/anim blueprints for Mesh1P and VR_Gun 
...
void AFirstPersonCharacter::BeginPlay()
{
	...
	// TODO: create a new VRGun and attach it to the skeleton - move all related code into it and make it run
